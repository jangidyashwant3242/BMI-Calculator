...
//  EeziCAB_Driver
//
//  Created by w3OnDemand on 11/09/19.
//  Copyright © 2019 bharat bhartia. All rights reserved.
//
...
//    func makeTostLive(str:NSString)
//    {
//        let window = UIApplication.shared.windows.last! as UIWindow
//        window.makeToast(str as String, duration: 3.0,  position: CALayerContentsGravity.bottom)
//    }
